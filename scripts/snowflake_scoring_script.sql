SELECT * FROM SIMULATION_DATA LIMIT 100;

SELECT MIN(ADMISSION_DATE), MAX(ADMISSION_DATE) FROM SIMULATION_DATA LIMIT 100;
SELECT MIN(ADMISSION_DATE), CURRENT_DATE-1 FROM SIMULATION_DATA;
...
SELECT * FROM BASE_WITH_FEATURES WHERE ADMISSION_DATE = CURRENT_DATE-1;




---- LOGGING TABLE
SELECT * FROM TEMP_LOS_PREDICTION_MODEL_LOGGING_TABLE;
